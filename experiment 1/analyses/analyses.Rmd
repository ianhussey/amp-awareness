...
1. Which of the Ruscio's As do you want to keep in the first chunk? Or both? One is commented out, not sure what you're doing there. 
...
When the DV is binary, we include a predicted probability for the model. This can be a useful addition to R^2.
...
Model predicted probability = `r h3_pp`.
