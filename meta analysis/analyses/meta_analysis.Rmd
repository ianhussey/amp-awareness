...
#   ggtitle("Relationship between influence rate and valence IA-AMP effect") 

data_participant_level %>%
  mutate(Experiment = paste(experiment, IA_AMP_domain)) %>%
  ggplot(aes(influence_rate, abs_IA_AMP_effect, color = Experiment)) +
