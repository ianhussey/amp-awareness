...
data_trial_level_valence_ia_amp  <- 
  ...
  mutate(Awareness = ifelse(influenced == 0, "Non-influence aware trials", ifelse(influenced == 1, "Influence aware trials", NA)),
...
if(file.exists("models/fit_trial_level.rds")){
  ...
  fit_trial_level <- 
    glmer(rating ~ Awareness * prime_type + (1 | experiment/unique_id),
          family = binomial(link = "logit"),
          data = data_trial_level_valence_ia_amp)
  
  dir.create("models")
  write_rds(fit_trial_level, file = "models/fit_trial_level.rds", compress = "gz")
