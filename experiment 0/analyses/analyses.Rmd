...
Payne et al. hypothesised that, if participants are influence-aware in the AMP, then AMP effects in the standard AMP should be larger than those of the skip AMP.
...
h2_fit <- data_processed_exclusions %>%
