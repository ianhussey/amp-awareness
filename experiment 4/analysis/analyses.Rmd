...
# extract OR
OR_h2a_1 <- exp(cbind(est=fixef(model_h2a_1), 
                   confint(model_h2a_1, parm="beta_", method="Wald")))

# convert OR to D
abs(timesavers::OR_to_d(OR_h2a_1))
...
# extract OR
OR_h2b_1 <- exp(cbind(est=fixef(model_h2b_1), 
                   confint(model_h2b_1, parm="beta_", method="Wald")))

# convert OR to D
abs(timesavers::OR_to_d(OR_h2b_1))
...
# results table
tab_model(fit_h2b_2, emph.p = FALSE, ci.hyphen = ", ")
